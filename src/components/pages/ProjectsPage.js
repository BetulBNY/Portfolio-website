...
export default function ProjectsPage() {
  ...
  const projects = [
      {
      id: 1,
      title: 'Autonomous E-Commerce Data Engineering & Analytics Platform',
    ...
    {
      id: 2,
      title: 'SQL Data Warehouse Project (Medallion Architecture)',
    ...
    {
      id: 3,
      title: 'Sales ETL Pipeline with Pentaho',
