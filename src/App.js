...
const Navbar = () => {
  ...
  const navItems = [{name: 'Home', path: '/'}, {name: 'Projects', path: 'projects'}, {name: 'Experiences', path: '/experiences'}, {name: 'Blog', path: '/blog'}];
 
  return (
    <nav style={styles.nav}>
      <div style={styles.navContainer}>
        <div style={styles.logo} onClick={() =>  navigate('/')}> BNY</div>
